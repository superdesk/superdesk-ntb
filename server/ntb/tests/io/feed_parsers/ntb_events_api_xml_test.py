...
class NTBEventsApiXMLTestCase(XMLParserTestCase):
    ...
    def test_name(self):
        self.assertEqual(
            "ISHOCKEY: Eliteserien menn (18. runde):", self.items[0]["name"]
        )
        self.assertEqual(
    ...
    def test_anpa_category(self):
        ...
        self.assertNotIn("anpa_category", self.items[1])

    def test_location(self):
        self.assertEqual(
            [{"name": "Tyskland", "qcode": "Tyskland"}], self.items[0]["location"]
        )
    ...
    def test_slugline(self):
        ...
        slug.sort()
        self.assertEqual(["Ishockey", "Nasjonal", "toppliga"], slug)
        self.assertEqual("Langrenn", self.items[1]["slugline"])
...
class NTBEventsFTPApiXMLTestCase(XMLParserTestCase):
    ...
    def test_event_contact_info_inculded(self):
        self.assertIn("event_contact_info", self.item)
    ...
    def test_event_contact_info_fields(self):
        ...
        self.assertEqual(
            ["marit.finnland.troite@miljodir.no"], contacts[0]["contact_email"]
        )
        self.assertEqual(
    ...
    def test_event_contact_info_id(self):
        ...
        self.assertEqual(self.item["event_contact_info"][0], contacts[0]["_id"])
