...
class NTBNewsML2TestCase(BaseNTBNewsML2TestCase):
    ...
    def test_content(self):
        ...
        self.assertEqual(
            item["headline"], "Nutrisystem beats 4Q earnings and revenue expectations"
        )
        ...
        self.assertEqual(
            ...
            '\n<p>This story was generated by <a href="http://www.automatedinsights.com'
            '/ap">Automated Insights</a> (http://automatedinsights.com/ap) using data '
            'from Zacks Investment Research. Access a <a href="https://www.zacks.com/ap'
            '/NTRI">Zacks stock report on NTRI</a> at https://www.zacks.com/ap/NTRI</p>'
            "\n            ",
        )
        self.assertEqual(
            item["guid"], "tag:ap.org,2011:5e565888b587889c5c8bd62b6164118c-text:2"
        )
