...
class DPATestCase(BaseDPANewsMLTestCase):
    ...
    def test_content(self):
        ...
        self.assertEqual(
            item["headline"],
            "Chef von Ölkonzern Eni soll wegen Nigeria-Schmiergeldern vor Gericht",
        )
        ...
        self.assertEqual(
            item["versioncreated"].isoformat(), "2017-12-20T14:49:36+01:00"
        )
        self.assertEqual(item["firstcreated"].isoformat(), "2017-12-20T14:49:36+01:00")
        self.assertEqual(item["ednote"], "Some other text")

        expected_body = (
            "<p>Rom (dpa) - Der Geschäftsführer des italienischen Energiekonzerns Eni, Claudio Descalzi, "
