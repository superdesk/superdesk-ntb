...
class STTBodyTestCase(BaseSolitaTestCase):
    ...
    def test_body(self):
        ...
        self.assertEqual(
            ...
            '/p>\n<h2>Kontakter</h2><p><name>Pressevakt NFD</name><br><title>Pressevakta er betent mellom 8.00 - 15.45 '
...
class STTDocumentsTestCase(BaseSolitaTestCase):
    ...
    def test_body(self):
        ...
        self.assertEqual(
            ...
            'bruar 2019.pptx</a>\n</p>\n<h2>Kontakter</h2><p><name>Per Einar Ruud i Bisnode</name><br><title>Kredittøko'
