...
class STTTestCase(BaseSolitaTestCase):
    ...
    def test_content(self):
        ...
        self.assertEqual(
            ...
            'a>\n</p>\n<p>Les hele denne saken fra <name>Nye Veier</name> på NTB info<br><a href="https://www.ntbinfo.n'
            'o/pressemelding/signerte-veikontrakt-pa-4-mrd-i-trondelag?releaseId=17854111">https://www.ntbinfo.no/press'
            'emelding/signerte-veikontrakt-pa-4-mrd-i-trondelag?releaseId=17854111</a></p>'
        )
...
class STTBodyTestCase(BaseSolitaTestCase):
    ...
    def test_body(self):
        ...
        self.assertEqual(
            ...
            '/p>\n<h2>Kontacter</h2><p><name>Pressevakt NFD</name><br><title>Pressevakta er betent mellom 8.00 - 15.45 '
            'på kvardagar (8.00-15.00 om sumaren).</title><br><phone>902 51 303 (ikkje SMS)</phone><br><email>media@nfd'
            '.dep.no</email></p>\n<p>Les hele denne saken fra <name>Nærings- og fiskeridepartementet</name> på NTB info'
            '<br><a href="https://www.ntbinfo.no/pressemelding/ekspertutvalg-skal-se-pa-bruk-av-private-velferdsleveran'
            'dorer?releaseId=17854144">https://www.ntbinfo.no/pressemelding/ekspertutvalg-skal-se-pa-bruk-av-private-ve'
            'lferdsleverandorer?releaseId=17854144</a></p>'
        )
...
class STTDocumentsTestCase(BaseSolitaTestCase):
    ...
    def test_body(self):
        ...
        self.assertEqual(
            ...
            'bruar 2019.pptx</a>\n</p>\n<h2>Kontacter</h2><p><name>Per Einar Ruud i Bisnode</name><br><title>Kredittøko'
            'nom, Bisnode</title><br><phone>+47 92 40 10 04\u2028</phone><br><email>per.einar.ruud@bisnode.com</email><'
            '/p>\n<p>Les hele denne saken fra <name>Bisnode</name> på NTB info<br><a href="https://www.ntbinfo.no/press'
            'emelding/nedgang-men-fortsatt-hoye-konkurstall-med-bransje--og-fylkesoversikt?releaseId=17861325">https://'
            'www.ntbinfo.no/pressemelding/nedgang-men-fortsatt-hoye-konkurstall-med-bransje--og-fylkesoversikt?releaseI'
            'd=17861325</a></p>'
        )
